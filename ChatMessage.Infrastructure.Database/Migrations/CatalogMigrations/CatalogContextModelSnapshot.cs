...
namespace ChatMesssage.Infrastructure.Database.Migrations.ChatMesssageMigrations
{
    ...
    partial class ChatMesssageContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatMesssage.Domain.Core.AggregatesModel.ProductAggregate.Product", b =>
                {
                    b.OwnsMany("ChatMesssage.Domain.Core.AggregatesModel.ProductAggregate.ProductAttachment", "ProductAttachments", b1 =>
                        {
                            ...
                            b1.ToTable("ProductAttachments", "ChatMesssage");
            ...
            modelBuilder.Entity("ChatMesssage.Domain.Core.Category", b =>
                {
                    b.OwnsOne("ChatMesssage.Domain.Core.AggregatesModel.CategoryAggregate.CategoryThumbnail", "Thumbnail", b1 =>
                        {
                            ...
                            b1.ToTable("Categories", "ChatMesssage");
